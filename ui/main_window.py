...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def browseFile(self):
        ...
        if file_path:
            ...
            if not is_valid:
                show_warning_dialog(self, "File Tidak Valid", message or "File tidak sesuai.")
                return
            elif message:
    ...
    def clearFile(self):
        ...
        self.file_handler.clean_files(parent_widget=self)
    ...
    def onModelChanged(self, model_type):
        ...
        if not is_valid:
            show_warning_dialog(self, "Peringatan Model Tidak Sesuai", warning_msg)
            return
    ...
    def onDetectionFailed(self, error_msg):
        ...
        show_warning_dialog(self, "Error Proses Deteksi", error_msg)
